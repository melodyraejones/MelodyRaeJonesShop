...
$product_price = get_field('program_price', $page_id);//discounted
$actual_price = 97; 
?>
        ...
        <div class="product-image-box product-image-box-wisdom">
            ...
            <?php if ($product_price) : ?>
                <div class="price-container">
                    ...
                    <p class="wisdom-program-price original-price"><?php echo esc_html(number_format((float)$product_price, 2)); ?></p>
